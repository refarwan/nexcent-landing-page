	...
	return (
		<header className="bg-silver flex h-[84px] items-center">
			<div className="m-auto flex w-full items-center justify-between px-[16px] xl:w-[1200px]">
				...
				>
					<img src="/logo.svg" className="h-[24px]" />
				</a>
				<div
					className={`${showMobileNavbar ? "visible" : "invisible"} fixed top-0 left-0 flex h-screen w-screen gap-[50px] bg-black/50 xl:visible xl:relative xl:top-[unset] xl:left-[unset] xl:h-max xl:w-max xl:bg-[unset]`}
